...
public abstract class AbstractNettyComponent implements Destroyable {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractNettyComponent.class);
    ...
    public AbstractNettyComponent(NetworkConfig config) {
        this.config = config;
